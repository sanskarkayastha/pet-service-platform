...
const destinations: Destination[] = [
  {
    ...
    image:
      "https://i.pinimg.com/1200x/9e/20/55/9e205537b6535b01a33b04ff24e8baea.jpg",
  },
  {
    label: "FurrEver",
    title: "Pet Shop",
    description:
      "Browse and shop for pet food, toys, accessories, and essentials from trusted vendors. Products can be ordered from anywhere and delivered to your doorstep.",
    image:
      "https://i.pinimg.com/736x/b3/b0/59/b3b0596511db909334c4fb34942d2b54.jpg",
  },
  {
    label: "FurrEver",
    title: "Grooming",
      ...
      <div className="hero-content">
        <div className="hero-text">
          ...
          <button className="discover-btn">
            <span className="btn-icon">📍</span> Discover Location
          </button>
        </div>
