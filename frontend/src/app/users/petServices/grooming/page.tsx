...
export default function GroomingPage() {
  ...
  useEffect(() => {
    const getBusinessData = async () => {
      try {
        const res = await fetch("http://localhost:8080/api/business/allBusinesses", {method:"GET"});
              ...
              <div className="service-card" key={business.userId}>
                ...
                <div className="card-content">
                  ...
                  <div className="card-footer">
                    <button className="btn-book" onClick={() => openModal(business)}>
                      Book Now
                    </button>
                    <Link
        ...
        <div className="modal" onClick={closeModal}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <p>📍 {selectedBusiness.businessAddress}, {selectedBusiness.city}</p>
            </div>
